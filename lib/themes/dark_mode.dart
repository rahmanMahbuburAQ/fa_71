...
ThemeData darkMode = ThemeData(
  colorScheme: ColorScheme.dark(
    surface: const Color.fromARGB(255, 20, 20, 20),// Use 'surface' instead of 'background'
  ...
  scaffoldBackgroundColor: const Color.fromARGB(255, 20, 20, 20),  // Set scaffold background color
);
